...
<div class="content">
    ...
    ?>
	<a  class='red delete_perm' href='?view=edit_place&place_id=<?=$_GET['place_id']?>&page=<?=$_GET['page']?>&delete_perm=yes' onclick="if(!confirm('Do you want to permanently delete place and all it\'s data')){return false;}">DELETE PERMANENTLY</a>
